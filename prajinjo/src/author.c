...
#define AUTHOR_STATEMENT "I, prajinjo, have read and understood the course academic integrity policy."
...
void author_response(int sock_index)
{
	...
	//printf("cntrl_response_payload = %s\n", cntrl_response_payload);
